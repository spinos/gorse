 ...
 *
 */
#ifndef ALO_MATRIX_33_F_H
#define ALO_MATRIX_33_F_H
...
/// b <- M a
	void transform1(Vector3F& b, const Vector3F & a) const;
	void transformReversed(Vector3F& b, const Vector3F & a) const;
	void transformInPlace(Vector3F& b) const;
